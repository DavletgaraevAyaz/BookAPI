...
namespace WebApplication1.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        {
            var book = await _booksService.GetBookssByIdAsync(id);
            if (book == null)
            {
        ...
        public async Task<IActionResult> AddBook([FromBody] Books newBook)
        {
            ...
            await _booksService.AddBookssAsync(newBook);
        ...
        public async Task<IActionResult> UpdateBook(int id, [FromBody] Books updatedBook)
        {
            ...
            await _booksService.UpdateBookssAsync(id, updatedBook);
        ...
        {
            await _booksService.DeleteBookssAsync(id);
